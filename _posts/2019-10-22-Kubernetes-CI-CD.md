...
gh-repo: Kubernetes-Best-Pratice/hanker-hello
...
[![installed k8s]({{ site.url }}/img/k8s/1_installed_k8s.png)]({{ site.url }}/img/k8s/1_installed_k8s.png)
...
_操作指引_： 【Manage Jenkins】->【Configure System】 
 ...
 [![add k8s cloud]({{ site.url }}/img/k8s/2_added_k8s_cloud.png)]({{ site.url }}/img/k8s/2_added_k8s_cloud.png)

 [![add k8s cloud config]({{ site.url }}/img/k8s/3_k8s_cloud_config.png)]({{ site.url }}/img/k8s/3_k8s_cloud_config.png)
...
3. 配置Kubernetes Pod Template
 ...
 [![k8s pod template]({{ site.url }}/img/k8s/4_k8s_pod_template.png)]({{ site.url }}/img/k8s/4_k8s_pod_template.png)
...
3. jenkins 验证信息
  * 添加 gitlab 帐号信息
  ...
  [![jenkins auth]({{ site.url }}/img/k8s/5_k8s_jenkins_auth.png)]({{ site.url }}/img/k8s/5_k8s_jenkins_auth.png)

  * harbor 信息

  _操作指引_：【Credentials】-> 【System】-> 【Global credentials】-> 【Add Credentials】

  [![jenkins harbor]({{ site.url }}/img/k8s/6_k8s_jenkins_harbor.png)]({{ site.url }}/img/k8s/6_k8s_jenkins_harbor.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/9_setup_k8s_auth.png)]({{ site.url }}/img/k8s/9_setup_k8s_auth.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/7_create_jenkins_pipeline.png)]({{ site.url }}/img/k8s/7_create_jenkins_pipeline.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/7_pipeline_checkout.png)]({{ site.url }}/img/k8s/7_pipeline_checkout.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/7_pipeline_docker.png)]({{ site.url }}/img/k8s/7_pipeline_docker.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/7_pipeline_configure.png)]({{ site.url }}/img/k8s/7_pipeline_configure.png)

### 3. 触发构建

[![setup k8s auth]({{ site.url }}/img/k8s/7_pipeline_trigger.png)]({{ site.url }}/img/k8s/7_pipeline_trigger.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/8_pipeline_result01.png)]({{ site.url }}/img/k8s/8_pipeline_result01.png)


3. 确认harbor镜像仓库里是否已经有新推送的镜像

[![setup k8s auth]({{ site.url }}/img/k8s/8_pipeline_result02.png)]({{ site.url }}/img/k8s/8_pipeline_result02.png)
...
[![setup k8s auth]({{ site.url }}/img/k8s/8_pipeline_result03.png)]({{ site.url }}/img/k8s/8_pipeline_result03.png)
